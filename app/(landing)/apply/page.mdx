...
on **{formatToLocal(registrationEndDate)}**.
...
Although the deadline is {formatToLocal(registrationEndDate, false, false)},
...
by 7:00 pm on {formatToLocal(eventDayBeforeDate, true, false)}
and by 9:30 am on {formatToLocal(eventDate, true, false)}
